...
const edgeAnimationHack = () => !isEdge() ? null : () => {
	edgeAnimationHack.state = ((edgeAnimationHack.state || 0) + 1) % 2;
	return {animationName: cx(edgeAnimationHack.state ? 'sticky-video' : 'sticky-video-dupe')};
};
...
class Video extends React.Component {
	...
	render () {
		...
		return (
			<Sticky className={cx('sticky-container')} edgeAnimationHack={edgeAnimationHack()}>
